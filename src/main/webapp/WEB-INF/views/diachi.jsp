...
<form method="get" action="timkiem.htm" >		
	...
	<div class="ui text container big breadcrumb">
		...
		<c:if test="${province!=null}">
			<a href="timkiem.htm?province=${province.id}">${province.name}></a>
			<c:if test="${district!=null}">
				<a href="timkiem.htm?province=${province.id}&district=${district.id}">${district.name}></a>
				<c:if test="${ward!=null}">
				<a href="timkiem.htm?province=${province.id}&district=${district.id}&ward=${ward.id}">${ward.name}></a>
				</c:if>
			</c:if>
		</c:if>
