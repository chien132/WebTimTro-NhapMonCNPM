...
<body>
	<div class="ui grid">
		<div class="five wide column">
			<b>Tỉnh/TP</b> <select class="ui search dropdown"
				id="comboboxProvince">
		...
		<div class="five wide column">
			<b>Quận/Huyện</b> <select class="ui search dropdown"
				id="comboboxDistrict"><option disabled="disabled">--Chọn
					huyện--</option></select>
		</div>
		<div class="five wide column">
			<b>Xã/Phường</b> <select class="ui search dropdown" id="comboboxWard"><option
					disabled="disabled">--Chọn xã--</option></select>
		</div>
		<!-- <div class="four wide column">
			<button class="ui button" style="margin-top: 38px;background-color: white;" id="filterButton">Tìm kiếm</button>
		</div> -->
...
$('#filterButton').click(function () {
	console.log(selected_ward)
	$('#result').html(selected_province.name+'<br>'+selected_district.name+'<br>'+selected_ward.name)
})
