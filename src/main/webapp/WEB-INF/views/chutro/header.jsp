...
<body>
	...
	<div class="sidenav" id="sidebar" onmouseleave="closeNav()">
		<div class="menu">
			...
			<div class="item">
			<a href="${pageContext.servletContext.contextPath}/chutro/taobaidang.htm" class="item">
			<i class="share square icon"></i> Tạo bài đăng mới </a></div>
			<div class="item">
			<a href="${pageContext.servletContext.contextPath}/chutro/lichhen.htm" class="item">
			<i class="calendar alternate outline icon"></i> Lịch hẹn xem phòng </a></div>
			<div class="item">
			<a href="${pageContext.servletContext.contextPath}/chutro/thongke.htm" class="item">
			<i class="chart bar outline icon"></i> Thống kê </a></div>
			<div class="item">
